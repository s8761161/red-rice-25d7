...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/red-rice-25d7
```

A live public deployment of this template is available at [https://red-rice-25d7.templates.workers.dev](https://red-rice-25d7.templates.workers.dev)
